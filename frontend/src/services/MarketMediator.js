    ...
    ---------------------------------------------------------------------*/
    export default function useMarketMediator() {
        ...
        const fetchBalance = useCallback(async () => {
            try {
                ...
                if (accounts.length > 0) setBalance(accounts[0] .equity);
            } catch (err) {
        ...
        const handlePlaceOrder = useCallback(async (side) => {
            try {
                ...
                const payload = {
                    ...
                    stop_loss:   tradeForm.stop_loss   === "" ? null : Number(tradeForm.stop_loss),
                    take_profit: tradeForm.take_profit  === "" ? null : Number(tradeForm.take_profit),
                };
